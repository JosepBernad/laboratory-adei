...
# TODO: Add Alex's library location
#missingPackages <- requiredPackages[!(requiredPackages %in% as.vector(installed.packages(lib.loc="alex/library/location")[,"Package"]))]
